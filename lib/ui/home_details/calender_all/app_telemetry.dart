...
class AppTelemetry extends StatefulWidget {
  const AppTelemetry({Key? key}) : super(key: key);

  @override
  _AppTelemetryState createState() => _AppTelemetryState();
}

class _AppTelemetryState extends State<AppTelemetry> {
  @override
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('App Telemetry',style: ButtonTextStyle,),
